...
Follow these steps to set up and deploy **SmartUtilFork**:
...
> **Special Note:** 💫: Configure the bot by setting values in either the `.env` file or directly in `config.py`—your choice! The default YouTube cookies path is `SmartUtilFork/cookies.txt`. Admins can dynamically adjust variables using the `/settings` command within the bot for quick and easy management. 👨‍💻
...
Deploying **SmartUtilFork** to Heroku is a straightforward process. Follow these steps to get your bot running on Heroku:
...
### Main Author 🧑‍💻
- The Main Author Is Abir Arafat Chawdhury Who Made The Base Development Of [SmartUtilFork](t.me/SmartUtlBot)
